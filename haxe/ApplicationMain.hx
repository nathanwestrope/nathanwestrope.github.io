...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("Final_project_CSC_303", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("Final_project_CSC_303", null, 640, 480);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "Final_project_CSC_303";
		app.meta["name"] = "Final_project_CSC_303";
