...
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_images_fireballold_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_images_nextcloudpi_activation_pdf extends null { }
...
@:keep @:bind @:noCompletion #if display private #end class __ASSET__assets_images_putty_0_73_installer_msi extends null { }
...
@:keep @:image("assets/images/fireballold.png") @:noCompletion #if display private #end class __ASSET__assets_images_fireballold_png extends lime.graphics.Image {}
@:keep @:file("assets/images/NextCloudPi Activation.pdf") @:noCompletion #if display private #end class __ASSET__assets_images_nextcloudpi_activation_pdf extends haxe.io.Bytes {}
...
@:keep @:file("assets/images/putty-0.73-installer.msi") @:noCompletion #if display private #end class __ASSET__assets_images_putty_0_73_installer_msi extends haxe.io.Bytes {}
